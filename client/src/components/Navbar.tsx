          ...
          <div className="hidden md:flex items-center space-x-4">
            {user ? (
              ...
              <div className="flex items-center space-x-4">
                ...
                <Link
                  to="/register"
                  className="px-6 py-2.5 bg-gray-900 text-white rounded-lg hover:bg-gray-800 font-medium transition-all hover:shadow-lg"
                >
                  注册
                </Link>
              </div>
                ...
                {user ? (
                  <>
                    {user.role === 'ADMIN' && (
                      <Link
                        to="/admin"
                        onClick={() => setIsMenuOpen(false)}
                        className="flex items-center gap-2 text-lg text-gray-700 hover:text-blue-600 font-medium py-2"
                      >
                    ...
                    <button
                      onClick={handleLogout}
                      className="flex items-center gap-2 text-lg text-red-600 hover:text-red-700 font-medium py-2 w-full"
                    >
                  ...
                  <>
                    <Link
                      to="/login"
                      onClick={() => setIsMenuOpen(false)}
                      className="block text-lg text-gray-700 hover:text-blue-600 font-medium py-2"
                    >
                      登录
                    </Link>
                    <Link
                      to="/register"
                      onClick={() => setIsMenuOpen(false)}
                      className="block text-lg text-center px-6 py-3 bg-gray-900 text-white rounded-lg hover:bg-gray-800 font-medium"
                    >
                      注册
                    </Link>
                  </>
