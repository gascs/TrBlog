...
<body class="bg-gray-100">
    ...
    <header class="bg-white shadow-sm">
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            <a href="<?php echo e(route('home')); ?>" class="text-2xl font-bold text-blue-600">TrBlog</a>
            ...
            <nav class="hidden md:flex space-x-6">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <?php if(auth()->user()->isAdmin()): ?>
                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="text-gray-700 hover:text-blue-600">Admin</a>
                    <?php endif; ?>
    ...
    <footer class="bg-gray-800 text-white py-8">
        <div class="container mx-auto px-4">
            ...
            <div class="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
                &copy; <?php echo e(date('Y')); ?> TrBlog. All rights reserved.
            </div>
        </div>
    </footer>
...
</html><?php /**PATH /workspace/trblog-php/resources/views/layouts/app.blade.php ENDPATH**/ ?>